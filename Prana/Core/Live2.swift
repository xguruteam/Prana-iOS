...
class Live2: NSObject {
    ...
    var delegates: [Live2Delegate] = []
    
    func addDelegate(_ delegate: Live2Delegate) {
        delegates.append(delegate)
    }
    
    func removeDelegate(_ delegate: Live2Delegate) {
    ...
    func resetCount() {
        if (count == Live2.maxCount) { //***march18
...
extension Live2: PranaDeviceManagerDelegate {
