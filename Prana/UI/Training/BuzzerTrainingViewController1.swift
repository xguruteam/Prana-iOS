...
class BuzzerTrainingViewController1: UIViewController {
    ...
    @IBOutlet weak var postureBuzzerSwitch: UISwitch!
...
//            self.btnNext.isEnabled = true
    ...
    @IBAction func onBuzzerForPostureChange(_ sender: UISwitch) {
        if sender.isOn {
...
//extension BuzzerTrainingViewController1: LiveDelegate {
...
//        DispatchQueue.main.async {
//            self.lblPostureValue.text = "\(self.objLive?.whichPostureFrame ?? 0)"
//        }
//    }
//
...
//}
//
//extension BuzzerTrainingViewController1: BuzzerDelegate {
