...
//            super.drawText(in: UIEdgeInsetsInsetRect(rect, edgeInsets))
            super.drawText(in: rect.inset(by: edgeInsets)) //modified by eli
        }
    ...
    @IBDesignable public class TSCTextField: UITextField {
        ...
        override public func textRect(forBounds bounds: CGRect) -> CGRect {
            return super.textRect(forBounds: bounds.inset(by: UIEdgeInsets(top: textInsets.height, left: textInsets.width, bottom: textInsets.height, right: textInsets.width)))
        }
        
        // text position
        override public func editingRect(forBounds bounds: CGRect) -> CGRect {
            //modified by eli
            return super.editingRect(forBounds: bounds.inset(by: UIEdgeInsets(top: textInsets.height, left: textInsets.width, bottom: textInsets.height, right: textInsets.width)))
